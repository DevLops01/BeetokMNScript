...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='beetok.conf'
CONFIGFOLDER='/root/.beetok-core'
COIN_DAEMON='beetokd'
COIN_CLI='beetok-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/Beetok/Beetok-Core/releases'
COIN_TGZ='https://github.com/Beetok/Beetok-Core/releases/download/v1.0.0.1/BEETOK-linux.tar.gz'
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}beetok-cli masternode status${NC}"
 echo -e "${GREEN}beetok-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
}
